...
(function($, undefined) {
  ...
  $.widget("ech.multiselect", {
    ...
    _create: function() {
      ...
      var button = (this.button = $('<input type="text"/>'))
...
//        .addClass('ui-multiselect ui-widget ui-state-default ui-corner-all')
        ...
        checkboxContainer = (this.checkboxContainer = $('<ul />'))
		  ...
		  hiddenName=$('<input type="hidden"/>').attr({'id': el.attr('labelid') ? el.attr('labelid') : null,'name': el.attr('labelid') ? el.attr('labelid') : null})
		  .insertAfter(el);
		  hiddenId=$('<input type="hidden"/>').attr({'id': el.attr('keyid') ? el.attr('keyid') : null,'name': el.attr('keyid') ? el.attr('keyid') : null})
		  .insertAfter(el);
    ...
    refresh: function(init) {
      ...
      var html = "";
      var $dropdown = $("<ul/>").addClass('ui-multiselect-checkboxes ui-helper-reset ul'+el.attr('id'));
...
//        }
    	  ...
    	  value = $checked.map(function() { return $(this).next().text(); }).get().join(o.selectedListSeparator);
    	  ids = $checked.map(function() { return $(this).val(); }).get().join(o.selectedListSeparator);
      }
      $(this.buttonlabel).parent().prev().prev().val(ids);
      $(this.buttonlabel).parent().prev().val(value);
    ...
    _setButtonValue: function(value) {
      ...
      $(this.buttonlabel).parent().val(value);
    },
